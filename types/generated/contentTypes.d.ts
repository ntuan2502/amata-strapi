...
export interface ApiDeviceModelDeviceModel extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    equipment_inventories: Schema.Attribute.Relation<
      'oneToMany',
      'api::equipment-inventory.equipment-inventory'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiEquipmentInventoryEquipmentInventory
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    device_model: Schema.Attribute.Relation<
      ...
      'api::device-model.device-model'
    >;
    device_status: Schema.Attribute.Enumeration<
      [
        'available',
        'donation',
        'in using',
    ...
    files: Schema.Attribute.Media<
      ...
      true
    >;
    hard_drive: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::equipment-inventory.equipment-inventory'
    > &
      Schema.Attribute.Private;
    mac_address: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    warranty_duration: Schema.Attribute.Enumeration<
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::equipment-inventory.equipment-inventory': ApiEquipmentInventoryEquipmentInventory;
